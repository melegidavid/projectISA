insert into user (id, username, password, email, name, last_name, city, telephone_number, last_password_reset_date,enabled, admin_change) values (21,'David', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra','melegi.david@gmail.com','David','Melegi','Zrenjanin','06334321','2017-08-19 12:17:55',true,true);
insert into user (id, username, password, email, name, last_name, city, telephone_number, last_password_reset_date,enabled, admin_change) values (22,'Rodja', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra','duka96@sbb.com','Dusan','Radj','Zrenjanin','060123123', '2017-08-19 12:17:55',true,true);
insert into user (id, username, password, email, name, last_name, city, telephone_number, last_password_reset_date,enabled, admin_change) values (23,'Kumara', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra','ra190.2015@gmail.com','Aleksandar','Joksimovic','Leskovac','060123123', '2017-08-19 12:17:55',true,true);
...
insert into avio_flight_seat (id, class_of_seat, free, number, deleted) values (500, "economy", false, 1, false);
insert into avio_flight_seat (id, class_of_seat, free, number, deleted) values (501, "economy", false, 2, false);
...
insert into avio_flight_seat (id, class_of_seat, free, number, deleted) values (506, "economy", true, 7, false);
