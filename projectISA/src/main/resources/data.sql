...
insert into avio_flight (id,date_time_start, date_time_finish,flight_duration,flight_distance,price, start_location_id, end_location_id, avio_company_id) values (2,'1 jun', '3 jun', 111, 3500, 350, 2, 1, 1);
insert into avio_flight (id,date_time_start, date_time_finish,flight_duration,flight_distance,price, start_location_id, end_location_id, avio_company_id) values (3,'1 jun', '3 jun', 111, 3500, 350, 3, 3, 1);

insert into destinations (avio_company_id, address_id) values (1, 1);
insert into destinations (avio_company_id, address_id) values (1, 2);
...
insert into hotel_menu_item (id, service_name, price, description, hotel_id) values (2,'Mini bar', 25.00, 'Neki random opis', 1);

insert into hotel_room (id, number, free, hotel_id, description, price, bed_number) values (1,'106', true, 1, 'opis prve sobe', 123.99, 2);
insert into hotel_room (id, number, free, hotel_id, description, price, bed_number) values (2,'107', true, 1, 'opis druge sobe', 100.00, 2);
insert into hotel_room (id, number, free, hotel_id, description, price, bed_number) values (3,'108', true, 1, 'opis trece sobe', 149.99, 2);

insert into hotel_room (id, number, free, hotel_id, description, price, bed_number) values (4,'206', true, 2, 'opis prve sobe', 123.00, 2);
insert into hotel_room (id, number, free, hotel_id, description, price, bed_number) values (5,'207', true, 2, 'opis druge sobe', 250.00, 3);
insert into hotel_room (id, number, free, hotel_id, description, price, bed_number) values (6,'208', true, 2, 'opis trece sobe', 150.00, 2);
insert into hotel_room (id, number, free, hotel_id, description, price, bed_number) values (7,'208', true, 2, 'opis cetvrte sobe', 150.00, 4);
...
insert into address(id, country, city, postal_code, street, number) values (3,'Srbija', 'Novi Sad',21000, 'Ulica neka', 33);